...
def koFwd(spot, strike, KOLevel, timetoexp, timetoKO, intrate, divyield, volatility):
    """Present value of a knockout forward contract using the Black-Scholes model.
    ...
    divyield : double    
        Asset dividend yield (continuous compounding)
    volatility : double
    ...
    -------
    double
        Present value of the knockout forward contract
    """
